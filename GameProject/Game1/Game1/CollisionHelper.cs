...
namespace Game1
{
    public static class CollisionHelper
    {
        ...
        public  static bool InBounds(this Rectangle r1, Rectangle r2, int offset = 40)
        {
            return (r1.Right >= r2.Left + (r2.Width / offset)
                        && r1.Left <= r2.Right - (r2.Width / offset));
        }

        public static bool TouchLeft(this Rectangle r1, Rectangle r2, int offset = 40)
        {
        ...
        public static bool TouchRight(this Rectangle r1, Rectangle r2, int offset = 40)
        {
        ...
        public static bool TouchBottom(this Rectangle r1, Rectangle r2, int offset = 15)
        {
